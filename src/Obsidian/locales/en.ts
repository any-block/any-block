...
If read mode, use the middle key for editing, press the middle key / Esc / move outside the cursor to focus and complete the editing.',
  'Pro editableblock render3': 'Read mode',
  'Pro editableblock render4': 'Real mode',
  'Pro callout': 'Callout selector',
  'Pro callout2': '(The modification requires restarting the plugin) \
Use the Callout selector and enable editable Callout',
