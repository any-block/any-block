...
Read mode: you need to press the middle key to enter the editing mode. Press the middle key / Esc / move the cursor outside to complete the editing.\n\
Teal time: allows for direct editing but requires more performance.',
